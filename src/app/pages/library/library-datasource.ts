...
const EXAMPLE_DATA: LibraryItem[] = [
  {
    id: 1, 
    name: 'Polar Rose', 
    equation: 'r(θ) = a * cos(nθ)',
    description: '1 A mathematical curve characterized by its symmetric, petal-like pattern.'
  },
  {
    id: 2, 
    name: 'Butterfly 1', 
...
/**
 * Data source for the Library view. This class should
 * encapsulate all logic for fetching and manipulating the displayed data
 * (including sorting, pagination, and filtering).
 */
export class LibraryDataSource extends DataSource<LibraryItem> {
  data: LibraryItem[] = EXAMPLE_DATA;
   ...
   */
  private getPagedData(data: LibraryItem[]): LibraryItem[] {
    if (this.paginator) {
   ...
   * this would be replaced by requesting the appropriate data from the server.
   */
  private getSortedData(data: LibraryItem[]): LibraryItem[] {
